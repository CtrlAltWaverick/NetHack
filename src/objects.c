...
WAND("secret door detection",
                        "balsa", 45, 150, 1, NODIR, WOOD, HI_WOOD),
...
WAND("make invisible", "marble", 40, 150, 1, IMMEDIATE, MINERAL, HI_MINERAL),
...
WAND("teleportation", "iridium", 40, 200, 1, IMMEDIATE, METAL,
                                                             CLR_BRIGHT_CYAN),
...
WAND("inversion",      "forked", 40, 200, 1, IMMEDIATE, WOOD, HI_WOOD),
/* extra descriptions, shuffled into use at start of new game */
